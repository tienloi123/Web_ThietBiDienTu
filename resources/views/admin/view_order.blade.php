        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>
              ...
              <input type="hidden" readonly name="order_qty_storage" class="order_qty_storage_{{$details->product_id}}" value="{{$details->product->product_quantity}}">

              <input type="hidden" readonlyname="order_code" class="order_code" value="{{$details->order_code}}">

              <input type="hidden" readonly name="order_product_id" class="order_product_id" value="{{$details->product_id}}">
