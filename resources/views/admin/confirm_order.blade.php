...
<body>
    <div class="container" style="background: #222; border-radius: 12px; padđing:15px;">
        <div class="col-md-12">
            ...
            <div class="row" style="background:cadetblue;padding:15px">
                ...
                <div class="col-md-6" style="text-align: center;color: #fff;font-weight:bold;font-size:30px">
                    ...
                    <p>Chào bạn <strong style="color: #000;text-decoration:underline;">{{ $shipping_array['customer_name']}}
                        ...
                        <div class="col-md-12">
                                <p style="color:#fff;font-size: 17px;">Bạn hoặc một ai đó đã đăng ký mua sắm tại shop laravel <a href="http://localhost:81/blog"> Tiến Lợi </a> với thông tin như sau:</p>
                        ...
                        <p style="color: fff;">Xem lịch sử đơn hàng đã đặt tại: <a href="#">Lịch sử đơn hàng</a> </p>
                        <p style="color:#fff">Mọi chi tiết xin liên hệ website tại: <a target="_blank" href="http://localhost:81/blog/">DoanTienLoi</a>, hoặc liên hệ qua số hotline : 0978610002.Xin cảm ơn quý khách đã đặt hàng tại shop chúng tôi.</p>
