                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                               ...
                               <li><a href="{{URL::to('/history')}}"><i class="fa fa-bell"></i> Lịch sử đơn hàng</a>
                             </li>
                             @php
        ...
        $(document).ready(function(){
            $('.add-to-cart').click(function(){
                ...
                $.ajax({
                    ...
                    :cart_product_image,cart_product_price:cart_product_price,cart_product_qty:cart_product_qty,
